...
Full documentation is available [here](https://docs.yithemes.com/flance-woocommerce-quick-view/).
...
* Update: Language file .pot. Changed textdomain to yith-wcqv to flance-woocommerce-quick-view
* Update: Plugin Core
...
If you can't find this plugin in your language and want to translate it, use the dedicated tool at [Translating WordPress](https://translate.wordpress.org/locale/it/default/wp-plugins/flance-woocommerce-quick-view "Translating WordPress").
