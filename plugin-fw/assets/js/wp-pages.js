/* global flance_plugin_fw_wp_pages, yith */
jQuery( function ( $ ) {
	...
	if ( flance_plugin_fw_wp_pages.bulk_delete_confirmation_enabled ) {
				...
				if ( bulkDeleteConfirmed ) {
					...
					if ( selectedItems.length ) {
						switch ( bulkActionSelector.val() ) {
							case 'trash':
								confirmOptions.title             = flance_plugin_fw_wp_pages.i18n.bulk_trash_confirm_title;
								confirmOptions.message           = flance_plugin_fw_wp_pages.i18n.bulk_trash_confirm_message;
								confirmOptions.cancelButton      = flance_plugin_fw_wp_pages.i18n.bulk_trash_cancel_button;
								confirmOptions.confirmButton     = flance_plugin_fw_wp_pages.i18n.bulk_trash_confirm_button;
								confirmOptions.confirmButtonType = 'delete';
								break;
							case 'delete':
								confirmOptions.title             = flance_plugin_fw_wp_pages.i18n.bulk_delete_confirm_title;
								confirmOptions.message           = flance_plugin_fw_wp_pages.i18n.bulk_delete_confirm_message;
								confirmOptions.cancelButton      = flance_plugin_fw_wp_pages.i18n.bulk_delete_cancel_button;
								confirmOptions.confirmButton     = flance_plugin_fw_wp_pages.i18n.bulk_delete_confirm_button;
								confirmOptions.confirmButtonType = 'delete';
								break;
						}
