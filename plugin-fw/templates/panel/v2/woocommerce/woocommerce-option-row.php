...
$extra_row_classes = (array) apply_filters( 'flance_plugin_fw_panel_wc_extra_row_classes', $extra_row_classes, $field );
...
?>
<div class="<?php echo esc_attr( $row_classes ); ?>" <?php echo flance_field_deps_data( $field ); ?>>
	<?php if ( $display_row ) : ?>
		...
		<div class="yith-plugin-fw__panel__option__content">
			<?php flance_plugin_fw_get_field( $field, true, $show_container ); ?>
		</div>
		<?php if ( ! ! $field['desc'] ) : ?>
